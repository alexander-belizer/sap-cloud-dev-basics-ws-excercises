...
* Add title -> Leave default values
...
* Change value of attribute `numberUnit`  to "USD" in eleme ObjectListItem
...
== Expand Category, Supplier in Controller
...
* Add namespace `xmlns:form="sap.ui.layout.form`
...
- in `semantic:headerContent` add element `ObjectHeader`
